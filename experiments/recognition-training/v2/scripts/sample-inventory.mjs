...
export async function buildSampleInventory(manifest, inputRoot) {
  ...
  return {
    schemaVersion: 1,
    id: 'synthetic-tilenet-v2-samples',
    datasetManifestSha256: sha256(`${JSON.stringify(manifest, null, 2)}\n`),
    generator: {
      command:
        'node scripts/sample-inventory.mjs --input data/full --output manifests/samples-v2.json',
...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
  ...
  if (typeof input !== 'string' || typeof output !== 'string') {
    throw new Error(
      'Usage: sample-inventory.mjs --input data/full --output manifests/samples-v2.json',
    );
  }
