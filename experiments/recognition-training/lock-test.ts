...
const bytes = await readFile(resolve(root, 'manifests/dataset-v1.json'));
...
const result = {
  ...
  command: 'node experiments/recognition-training/lock-test.ts',
...
await writeFile(
  resolve(root, 'manifests/test-lock-v1.json'),
